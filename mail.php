<?php
require_once '../functions/mandrill-api-php/src/Mandrill.php'; //Not required with Composer
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a href="http://www.rakuten.co.jp" target="_blank">
          
          <span style="margin-left:10px">
            <img src="https://www-techinasia.netdna-ssl.com/wp-content/uploads/2013/01/rakuten-logo-global.jpg?17bc4c" width="126" alt="amazon.in" height="56" border="0">
          </span>
  ...
  <span style="font-size:14px;color:#999999;font-family:arial,helvetica,verdana,sans-serif;">
    ...
    <tr>
      <td colspan="2">
        ...
        'subject' => 'Rakuten Ichiba Help Me Choose',
        'from_email' => 'shinde.amit27031991@gmail.com',
        'from_name' => 'Help Me Choose Support',
        'to' => array(
            array(
                'email' => 'shinde.amit27031991@gmail.com',
                //'name' => 'Recipient Name',
                'type' => 'to'
            )
        ),
        'headers' => array('Reply-To' => 'shinde.amit27031991@gmail.com'),
        'important' => false,
        'track_opens' => null,
        'track_clicks' => null,
        'auto_text' => null,
